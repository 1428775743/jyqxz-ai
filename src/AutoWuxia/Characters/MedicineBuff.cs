...
/// <summary>
/// 玩家身上的药物增益(药buff)。同时只能挂1个,吃新药覆盖旧的。
/// 持续以"天"为单位(每日TickDay递减,0自动清除)。战斗中通过 GetTotal* 生效。
/// BuffType: atk/def/speed/maxhp/maxmp/regen (regen=战斗中每回合回血 Value 比例最大HP)
/// </summary>
public class MedicineBuff
{
    /// <summary>来源药物ID(防重复/展示)</summary>
    public string BuffId { get; set; } = "";

    /// <summary>显示名(聚力丹/铁骨丹…)</summary>
