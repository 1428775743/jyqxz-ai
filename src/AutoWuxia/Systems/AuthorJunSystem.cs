...
{
    public const int MythicRewardWinRequirement = 20;
    ...
    public static DialogueScript BuildIntroScript()
    {
        return new DialogueScript
        {
            Lines =
            {
                ...
                new DialogueLine { Speaker = EndgameSystem.AuthorId, Lines = { "说得好。武功我不会直接传你，机缘还得自己去江湖里寻。", "若能在切磋中累计胜我二十次，我便让你在神话内功与神话外功中选一门自创。记住，只能二选一。" } },
